...
// MIZAR_NAMESPACE::FSSequentialFileWrapper {
//  public:
//   MySequentialFileWrapper(MIZAR_NAMESPACE::FSSequentialFile* target):
//     MIZAR_NAMESPACE::FSSequentialFileWrapper(target) {}
...
//     return MIZAR_NAMESPACE::FSSequentialFileWrapper::Read(n, options,
//     result,
//                                                 scratch, dbg);
//   }
