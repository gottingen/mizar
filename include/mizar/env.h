...
#include "mizar/functor_wrapper.h"
...
// MIZAR_NAMESPACE::SequentialFileWrapper {
//  public:
//   MySequentialFileWrapper(MIZAR_NAMESPACE::SequentialFile* target):
//     MIZAR_NAMESPACE::SequentialFileWrapper(target) {}
//   Status Read(size_t n, Slice* result, char* scratch) override {
//     cout << "Doing a read of size " << n << "!" << endl;
//     return MIZAR_NAMESPACE::SequentialFileWrapper::Read(n, result,
//     scratch);
//   }
