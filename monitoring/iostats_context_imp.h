...
#if defined(MIZAR_SUPPORT_THREAD_LOCAL) && !defined(NIOSTATS_CONTEXT)
...
#else  // MIZAR_SUPPORT_THREAD_LOCAL && !NIOSTATS_CONTEXT
...
#endif  // MIZAR_SUPPORT_THREAD_LOCAL && !NIOSTATS_CONTEXT
