...
CFLAGS+=" $DEPS_INCLUDE"
CFLAGS+=" -DMIZAR_PLATFORM_POSIX -DMIZAR_LIB_IO_POSIX -DMIZAR_FALLOCATE_PRESENT -DMIZAR_MALLOC_USABLE_SIZE -DMIZAR_RANGESYNC_PRESENT -DMIZAR_SCHED_GETCPU_PRESENT -DMIZAR_SUPPORT_THREAD_LOCAL -DHAVE_SSE42"
