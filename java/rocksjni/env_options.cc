...
// calling C++ MIZAR_NAMESPACE::EnvOptions methods
// from Java side.
...
#define ENV_OPTIONS_SET_BOOL(_jhandle, _opt)                          \
  reinterpret_cast<MIZAR_NAMESPACE::EnvOptions *>(_jhandle)->_opt = \
...
jlong Java_org_rocksdb_EnvOptions_newEnvOptions__(
    JNIEnv*, jclass) {
  auto *env_opt = new MIZAR_NAMESPACE::EnvOptions();
...
jlong Java_org_rocksdb_EnvOptions_newEnvOptions__J(
  ...
  auto *db_options =
      reinterpret_cast<MIZAR_NAMESPACE::DBOptions *>(jdboptions_handle);
  auto *env_opt = new MIZAR_NAMESPACE::EnvOptions(*db_options);
  return reinterpret_cast<jlong>(env_opt);
}
...
void Java_org_rocksdb_EnvOptions_disposeInternal(
  ...
  auto *eo = reinterpret_cast<MIZAR_NAMESPACE::EnvOptions *>(jhandle);
  assert(eo != nullptr);
  delete eo;
}
...
void Java_org_rocksdb_EnvOptions_setRateLimiter(
  ...
  auto *sptr_rate_limiter =
      reinterpret_cast<std::shared_ptr<MIZAR_NAMESPACE::RateLimiter> *>(
          rl_handle);
  auto *env_opt = reinterpret_cast<MIZAR_NAMESPACE::EnvOptions *>(jhandle);
