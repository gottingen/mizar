...
void Java_org_rocksdb_RocksIterator_disposeInternal(JNIEnv* /*env*/,
                                                    jobject /*jobj*/,
                                                    jlong handle) {
  auto* it = reinterpret_cast<MIZAR_NAMESPACE::Iterator*>(handle);
  assert(it != nullptr);
  delete it;
}
...
jboolean Java_org_rocksdb_RocksIterator_isValid0(JNIEnv* /*env*/,
                                                 jobject /*jobj*/,
                                                 jlong handle) {
  return reinterpret_cast<MIZAR_NAMESPACE::Iterator*>(handle)->Valid();
}
...
void Java_org_rocksdb_RocksIterator_seekToFirst0(JNIEnv* /*env*/,
                                                 jobject /*jobj*/,
                                                 jlong handle) {
  reinterpret_cast<MIZAR_NAMESPACE::Iterator*>(handle)->SeekToFirst();
}
...
void Java_org_rocksdb_RocksIterator_seekToLast0(JNIEnv* /*env*/,
                                                jobject /*jobj*/,
                                                jlong handle) {
  reinterpret_cast<MIZAR_NAMESPACE::Iterator*>(handle)->SeekToLast();
}
...
void Java_org_rocksdb_RocksIterator_next0(JNIEnv* /*env*/, jobject /*jobj*/,
                                          jlong handle) {
  reinterpret_cast<MIZAR_NAMESPACE::Iterator*>(handle)->Next();
}
...
void Java_org_rocksdb_RocksIterator_prev0(JNIEnv* /*env*/, jobject /*jobj*/,
                                          jlong handle) {
  reinterpret_cast<MIZAR_NAMESPACE::Iterator*>(handle)->Prev();
}
...
void Java_org_rocksdb_RocksIterator_refresh0(JNIEnv* env, jobject /*jobj*/,
                                            jlong handle) {
  auto* it = reinterpret_cast<MIZAR_NAMESPACE::Iterator*>(handle);
  MIZAR_NAMESPACE::Status s = it->Refresh();
...
void Java_org_rocksdb_RocksIterator_seekForPrevDirect0(
  ...
  auto* it = reinterpret_cast<MIZAR_NAMESPACE::Iterator*>(handle);
  auto seekPrev = [&it](MIZAR_NAMESPACE::Slice& target_slice) {
    it->SeekForPrev(target_slice);
  };
  MIZAR_NAMESPACE::JniUtil::k_op_direct(seekPrev, env, jtarget, jtarget_off,
                                          jtarget_len);
}
...
jbyteArray Java_org_rocksdb_RocksIterator_key0(JNIEnv* env, jobject /*jobj*/,
                                               jlong handle) {
  auto* it = reinterpret_cast<MIZAR_NAMESPACE::Iterator*>(handle);
  MIZAR_NAMESPACE::Slice key_slice = it->key();
...
jint Java_org_rocksdb_RocksIterator_keyDirect0(JNIEnv* env, jobject /*jobj*/,
  ...
  auto* it = reinterpret_cast<MIZAR_NAMESPACE::Iterator*>(handle);
  MIZAR_NAMESPACE::Slice key_slice = it->key();
  return MIZAR_NAMESPACE::JniUtil::copyToDirect(env, key_slice, jtarget,
...
jbyteArray Java_org_rocksdb_RocksIterator_value0(JNIEnv* env, jobject /*jobj*/,
                                                 jlong handle) {
  auto* it = reinterpret_cast<MIZAR_NAMESPACE::Iterator*>(handle);
  MIZAR_NAMESPACE::Slice value_slice = it->value();
...
jint Java_org_rocksdb_RocksIterator_valueDirect0(JNIEnv* env, jobject /*jobj*/,
  ...
  auto* it = reinterpret_cast<MIZAR_NAMESPACE::Iterator*>(handle);
  MIZAR_NAMESPACE::Slice value_slice = it->value();
  return MIZAR_NAMESPACE::JniUtil::copyToDirect(env, value_slice, jtarget,
                                                  jtarget_off, jtarget_len);
}
