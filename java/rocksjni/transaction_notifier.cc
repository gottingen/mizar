...
// for MIZAR_NAMESPACE::TransactionNotifier.
...
jlong Java_org_rocksdb_AbstractTransactionNotifier_createNewTransactionNotifier(
  ...
  auto* transaction_notifier =
      new MIZAR_NAMESPACE::TransactionNotifierJniCallback(env, jobj);
  auto* sptr_transaction_notifier =
      new std::shared_ptr<MIZAR_NAMESPACE::TransactionNotifierJniCallback>(
...
void Java_org_rocksdb_AbstractTransactionNotifier_disposeInternal(
  ...
  std::shared_ptr<MIZAR_NAMESPACE::TransactionNotifierJniCallback>* handle =
      reinterpret_cast<
