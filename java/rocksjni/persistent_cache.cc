...
// MIZAR_NAMESPACE::PersistentCache.
...
jlong Java_org_rocksdb_PersistentCache_newPersistentCache(
  ...
  auto* rocks_env = reinterpret_cast<MIZAR_NAMESPACE::Env*>(jenv_handle);
  jboolean has_exception = JNI_FALSE;
  std::string path =
      MIZAR_NAMESPACE::JniUtil::copyStdString(env, jpath, &has_exception);
  ...
  auto* logger =
      reinterpret_cast<std::shared_ptr<MIZAR_NAMESPACE::LoggerJniCallback>*>(
          jlogger_handle);
  auto* cache =
      new std::shared_ptr<MIZAR_NAMESPACE::PersistentCache>(nullptr);
  MIZAR_NAMESPACE::Status s = MIZAR_NAMESPACE::NewPersistentCache(
