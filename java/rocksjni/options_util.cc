...
// calling C++ MIZAR_NAMESPACE::OptionsUtil methods from Java side.
...
void build_column_family_descriptor_list(
    ...
    std::vector<MIZAR_NAMESPACE::ColumnFamilyDescriptor>& cf_descs) {
  ...
  for (MIZAR_NAMESPACE::ColumnFamilyDescriptor& cfd : cf_descs) {
    // Construct a ColumnFamilyDescriptor java object
    jobject jcfd =
        MIZAR_NAMESPACE::ColumnFamilyDescriptorJni::construct(env, &cfd);
...
void Java_org_rocksdb_OptionsUtil_loadLatestOptions__Ljava_lang_String_2JJLjava_util_List_2Z(
  ...
  auto db_path =
      MIZAR_NAMESPACE::JniUtil::copyStdString(env, jdbpath, &has_exception);
  if (has_exception == JNI_TRUE) {
    // exception occurred
    return;
  }
  std::vector<MIZAR_NAMESPACE::ColumnFamilyDescriptor> cf_descs;
  MIZAR_NAMESPACE::Status s = MIZAR_NAMESPACE::LoadLatestOptions(
      db_path, reinterpret_cast<MIZAR_NAMESPACE::Env*>(jenv_handle),
      reinterpret_cast<MIZAR_NAMESPACE::DBOptions*>(jdb_opts_handle),
...
void Java_org_rocksdb_OptionsUtil_loadOptionsFromFile__Ljava_lang_String_2JJLjava_util_List_2Z(
    ...
    jlong jdb_opts_handle, jobject jcfds, jboolean ignore_unknown_options) {
  jboolean has_exception = JNI_FALSE;
  auto opts_file_name = MIZAR_NAMESPACE::JniUtil::copyStdString(
  ...
  std::vector<MIZAR_NAMESPACE::ColumnFamilyDescriptor> cf_descs;
  MIZAR_NAMESPACE::Status s = MIZAR_NAMESPACE::LoadOptionsFromFile(
      opts_file_name, reinterpret_cast<MIZAR_NAMESPACE::Env*>(jenv_handle),
      reinterpret_cast<MIZAR_NAMESPACE::DBOptions*>(jdb_opts_handle),
      &cf_descs, ignore_unknown_options);
  if (!s.ok()) {
    // error, raise an exception
...
jstring Java_org_rocksdb_OptionsUtil_getLatestOptionsFileName(
  ...
  MIZAR_NAMESPACE::Status s = MIZAR_NAMESPACE::GetLatestOptionsFileName(
      db_path, reinterpret_cast<MIZAR_NAMESPACE::Env*>(jenv_handle),
      &options_file_name);
  if (!s.ok()) {
    // error, raise an exception
