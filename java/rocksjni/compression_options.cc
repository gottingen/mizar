...
// MIZAR_NAMESPACE::CompressionOptions.
...
jlong Java_org_rocksdb_CompressionOptions_newCompressionOptions(
    JNIEnv*, jclass) {
  const auto* opt = new MIZAR_NAMESPACE::CompressionOptions();
...
void Java_org_rocksdb_CompressionOptions_setWindowBits(
  ...
  auto* opt = reinterpret_cast<MIZAR_NAMESPACE::CompressionOptions*>(jhandle);
...
void Java_org_rocksdb_CompressionOptions_disposeInternal(
    JNIEnv*, jobject, jlong jhandle) {
  delete reinterpret_cast<MIZAR_NAMESPACE::CompressionOptions*>(jhandle);
}
