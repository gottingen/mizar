...
// calling c++ MIZAR_NAMESPACE::TtlDB methods.
// from Java side.
...
jlong Java_org_rocksdb_TtlDB_open(
  ...
  auto* opt = reinterpret_cast<MIZAR_NAMESPACE::Options*>(joptions_handle);
  MIZAR_NAMESPACE::DBWithTTL* db = nullptr;
  MIZAR_NAMESPACE::Status s =
      MIZAR_NAMESPACE::DBWithTTL::Open(*opt, db_path, &db, jttl, jread_only);
...
jlongArray Java_org_rocksdb_TtlDB_openCF(
  ...
  MIZAR_NAMESPACE::DBWithTTL* db = nullptr;
  MIZAR_NAMESPACE::Status s = MIZAR_NAMESPACE::DBWithTTL::Open(
...
void Java_org_rocksdb_TtlDB_disposeInternal(
  ...
  auto* ttl_db = reinterpret_cast<MIZAR_NAMESPACE::DBWithTTL*>(jhandle);
...
void Java_org_rocksdb_TtlDB_closeDatabase(
  ...
  // auto* ttl_db = reinterpret_cast<MIZAR_NAMESPACE::DBWithTTL*>(jhandle);
  // assert(ttl_db != nullptr);
  // MIZAR_NAMESPACE::Status s = ttl_db->Close();
  // MIZAR_NAMESPACE::RocksDBExceptionJni::ThrowNew(env, s);
...
jlong Java_org_rocksdb_TtlDB_createColumnFamilyWithTtl(
  ...
  auto* cfOptions = reinterpret_cast<MIZAR_NAMESPACE::ColumnFamilyOptions*>(
      jcolumn_options);

  auto* db_handle = reinterpret_cast<MIZAR_NAMESPACE::DBWithTTL*>(jdb_handle);
  MIZAR_NAMESPACE::ColumnFamilyHandle* handle;
  MIZAR_NAMESPACE::Status s = db_handle->CreateColumnFamilyWithTtl(
