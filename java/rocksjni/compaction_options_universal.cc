...
// MIZAR_NAMESPACE::CompactionOptionsUniversal.
...
jlong Java_org_rocksdb_CompactionOptionsUniversal_newCompactionOptionsUniversal(
    JNIEnv*, jclass) {
  const auto* opt = new MIZAR_NAMESPACE::CompactionOptionsUniversal();
...
void Java_org_rocksdb_CompactionOptionsUniversal_setSizeRatio(
  ...
  auto* opt =
      reinterpret_cast<MIZAR_NAMESPACE::CompactionOptionsUniversal*>(jhandle);
...
void Java_org_rocksdb_CompactionOptionsUniversal_setStopStyle(
  ...
  auto* opt =
      reinterpret_cast<MIZAR_NAMESPACE::CompactionOptionsUniversal*>(jhandle);
  opt->stop_style =
      MIZAR_NAMESPACE::CompactionStopStyleJni::toCppCompactionStopStyle(
          jstop_style_value);
}
...
jbyte Java_org_rocksdb_CompactionOptionsUniversal_stopStyle(
  ...
  auto* opt =
      reinterpret_cast<MIZAR_NAMESPACE::CompactionOptionsUniversal*>(jhandle);
  return MIZAR_NAMESPACE::CompactionStopStyleJni::toJavaCompactionStopStyle(
      opt->stop_style);
}
...
void Java_org_rocksdb_CompactionOptionsUniversal_disposeInternal(
    JNIEnv*, jobject, jlong jhandle) {
  delete reinterpret_cast<MIZAR_NAMESPACE::CompactionOptionsUniversal*>(
      jhandle);
}
