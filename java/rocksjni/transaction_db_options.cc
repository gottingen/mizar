...
// for MIZAR_NAMESPACE::TransactionDBOptions.
...
jlong Java_org_rocksdb_TransactionDBOptions_newTransactionDBOptions(
  ...
  MIZAR_NAMESPACE::TransactionDBOptions* opts =
      new MIZAR_NAMESPACE::TransactionDBOptions();
...
jlong Java_org_rocksdb_TransactionDBOptions_getMaxNumLocks(JNIEnv* /*env*/,
                                                           ...
                                                           jlong jhandle) {
  auto* opts =
      reinterpret_cast<MIZAR_NAMESPACE::TransactionDBOptions*>(jhandle);
...
jbyte Java_org_rocksdb_TransactionDBOptions_getWritePolicy(JNIEnv* /*env*/,
  ...
  auto* opts =
      reinterpret_cast<MIZAR_NAMESPACE::TransactionDBOptions*>(jhandle);
  return MIZAR_NAMESPACE::TxnDBWritePolicyJni::toJavaTxnDBWritePolicy(
      opts->write_policy);
}
...
void Java_org_rocksdb_TransactionDBOptions_setWritePolicy(JNIEnv* /*env*/,
  ...
  auto* opts =
      reinterpret_cast<MIZAR_NAMESPACE::TransactionDBOptions*>(jhandle);
  opts->write_policy =
      MIZAR_NAMESPACE::TxnDBWritePolicyJni::toCppTxnDBWritePolicy(
          jwrite_policy);
}
...
void Java_org_rocksdb_TransactionDBOptions_disposeInternal(JNIEnv* /*env*/,
                                                           jobject /*jobj*/,
                                                           jlong jhandle) {
  delete reinterpret_cast<MIZAR_NAMESPACE::TransactionDBOptions*>(jhandle);
}
