...
// for MIZAR_NAMESPACE::TransactionOptions.
...
jlong Java_org_rocksdb_TransactionOptions_newTransactionOptions(
  ...
  auto* opts = new MIZAR_NAMESPACE::TransactionOptions();
...
jboolean Java_org_rocksdb_TransactionOptions_isSetSnapshot(JNIEnv* /*env*/,
                                                           ...
                                                           jlong jhandle) {
  auto* opts =
      reinterpret_cast<MIZAR_NAMESPACE::TransactionOptions*>(jhandle);
...
void Java_org_rocksdb_TransactionOptions_disposeInternal(JNIEnv* /*env*/,
                                                         jobject /*jobj*/,
                                                         jlong jhandle) {
  delete reinterpret_cast<MIZAR_NAMESPACE::TransactionOptions*>(jhandle);
}
